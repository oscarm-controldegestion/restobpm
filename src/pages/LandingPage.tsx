        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 lg:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6 landing-fade-up landing-fade-up-1">
              El SEREMI no avisa.<br/>
              <span className="text-blue-300">¿Tu local está listo</span><br/>
              para hoy?
            </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-red-100 landing-card-hover">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">Sin registro digital, el incumplimiento pasa desapercibido hasta que el SEREMI ya está en la puerta — y la multa, en el bolsillo.</p>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { bg: 'bg-blue-50', border: 'border-blue-200', ibg: 'bg-blue-600', title: 'Informe PDF para el SEREMI', desc: 'Genera el informe de cumplimiento BPM en segundos. Con firma digital, folio y todos los registros del período. Muéstralo en la fiscalización.', icon: <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg> },
      ...
      <section id="modulos" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-gray-500 max-w-2xl mx-auto text-base">Basados en el D.S. 977/96 y los requerimientos del SEREMI para establecimientos de producción y expendio de alimentos.</p>
          </div>
          ...
          <div className="mt-10 bg-[#1F3864] rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-white">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">Checklists diseñados según los requerimientos del SEREMI para establecimientos de alimentos en Chile.</p>
              </div>
            </div>
