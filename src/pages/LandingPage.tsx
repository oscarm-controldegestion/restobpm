      ...
      <section id="problemas" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <p className="text-sm font-semibold text-[#ff4d55] uppercase tracking-widest mb-6">El problema</p>
            <img
              src="/prohibicion.svg"
              alt="Prohibición de Funcionamiento SEREMI de Salud"
              className="mx-auto mb-6 max-h-52 w-auto drop-shadow-xl"
            />
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#ff4d55] leading-tight">
              Evítalo con RestoBPM
            </h2>
          </div>
